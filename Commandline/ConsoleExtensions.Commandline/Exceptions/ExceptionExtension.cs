...
public static class ExceptionExtension
{
    ...
    public static Controller AddExceptionHandling(this Controller controller)
    {
        ...
        controller.TemplateParser.AddTypeTemplate<Exception>(
            "[s:error]An unknown exception occurred.[br/][/] {Message}");
        controller.TemplateParser.AddTypeTemplate<TaskCanceledException>(
            "[s:error]The task was canceled by the user.[br/][/]");
