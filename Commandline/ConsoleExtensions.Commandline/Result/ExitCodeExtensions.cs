...
public static class ExitCodeExtensions
{
    ...
    public static Controller AddDefaultExitCodes(this Controller controller)
    {
        ...
        //// Task exceptions
        //controller.AddExceptionExitCode<TaskCanceledException>(2, "Canceled", "The command was canceled by the user")
        //    .AddExceptionExitCode<TimeoutException>(3, "Timeout", "The command was executed with an timeout error")
        //    .AddExceptionExitCode<OperationCanceledException>(4, "Operation canceled", "The command was canceled by the user");
            
        //// Inner exceptions
        //controller.AddExceptionExitCode<ArgumentException>(10, "Argument error", "The command was executed with an invalid argument")
        //    .AddExceptionExitCode<AggregateException>(11, "Aggregate error", "The command was executed with an aggregate error")
        //    .AddExceptionExitCode<NotImplementedException>(12, "Not implemented", "The command was not implemented")
        ...
        controller.AddExceptionExitCode<InvalidArgumentFormatException>(0, "Invalid argument format", "The command was executed with an invalid argument format")
    ...
    /// <returns>The controller</returns>
    public static Controller AddExitCode(this Controller controller, Func<object, bool> match, int code, string name,
        string description = null, ExitCodeOrder order = ExitCodeOrder.Default)
    {
    ...
    /// <param name="order">The order.</param>
    /// <returns>The controller</returns>
    public static Controller AddExitCode<T>(this Controller controller, Func<T, bool> match, int code, string name,
        string description = null, ExitCodeOrder order = ExitCodeOrder.Default)
    {
    ...
    /// <param name="order">The order.</param>
    /// <returns>The controller</returns>
    public static Controller AddExceptionExitCode<T>(this Controller controller, int code, string name,
        string description = null, ExitCodeOrder order = ExitCodeOrder.Default) where T : Exception
    {
